...
class GLTFWriter {
	...
	buildMetalRoughTexture( metalnessMap, roughnessMap ) {
		...
		const width = Math.max( metalness ? metalness.width  : null|| 0, roughness ? roughness.width : null || 0 );
		const height = Math.max( metalness? metalness.height : null || 0, roughness ? roughness.height : null || 0 );
